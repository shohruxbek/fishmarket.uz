...
<html lang="uz">
  ...
  <body><section><container>
    ...
    action="includes/login.inc.php" method="POST">
      <img class="mb-4" src="images/flat/a144.png"  alt="" width="72" height="72">
      
      <input type="text" name="uid" class="form-control" placeholder="Log-in/e-mail" required autofocus>
      
      <input type="password" name="pwd" class="form-control" placeholder="Parol" required>
      
<a href="passrec.php">Parolni tiklash</a>

      <button class="btn btn-lg btn-primary btn-block" type="submit" name="submit">Kirish</button>
    </form>
